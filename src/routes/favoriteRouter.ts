...
router.delete("/favorite/:idUsuario/:idOng", (req, res) => {
    console.info(`> Request DELETE recieved in '/favorite' at ${new Date().toLocaleString()}. \n> req.params:`, req.params);
...
router.get("/favorite/:idUsuario", (req, res) => {
    ...
    favController.allOngsPerUser(req, res);
});
